...
export default function SignUpMessagePage ({ currentMessage }: { currentMessage: string }) {
   ...
   return (
      <AppWrapper>
         <div className="text-xs pd-05 grey-4">Ayeik Perfumes Email & SMS Marketing</div>
         <div className="text-l full bold-600">Custom Welcome Message</div>
         <Spacing />
         <div className="box full">
            <textarea 
               className="xxs pd-15 pdx-2 full radius-20 h-35"
         ...
         <div className="box full pd-05">
            <AwaitButton 
               className="xxs pd-12 pdx-3 radius-20"
