...
export default function InsightsChart ({ totalSubscribers }: InsightsPageProps) {
   ...
   return (
      <div className="box full pd-05 dfb column">
         <div className="box full mb-1 dfb align-center justify-end">
            <Select
               ...
               optionStyle={{ padding: "9px 12px", borderRadius: "22px" }}
            />
         </div>
